...
CREATE TABLE IF NOT EXISTS silver.fato_movimentacoes (
    ...
    id_produto_servico TEXT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS uq_fato_movimentacoes_business_key
    ON silver.fato_movimentacoes (id_movimentacao, id_produto_servico, id_pessoa);
